...
import heroImage from '@/assets/hero-wedding1.jpg';
    ...
    return (
        <section className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#44121B]">
            ...
            >
                ...
                <div
                    className="rounded-[28px] bg-[#44121B]/18 px-6 py-8 shadow-[0_18px_50px_rgba(68,18,27,0.25)] backdrop-blur-[2px] md:px-12 md:py-10">
                    {/* Decorative flourish */}
                    <div className="mb-6 flex items-center justify-center gap-3">
                        <span
                            className="h-px w-12 bg-gradient-to-r from-transparent via-[#B6B27C] to-transparent md:w-20"/>
              ...
              `
                    ...
                    <div className="mb-7 flex items-center justify-center gap-4">
                        <span
                            className="h-px w-16 bg-gradient-to-r from-transparent via-[#B5B063] to-transparent md:w-24"/>
